...
model.save('8_lang_model_10s_{}_epochs.h5'.format(num_epochs))
pd.DataFrame.from_dict(history.history).to_csv('8_lang_history_10s_{}_epochs.csv'.format(num_epochs),index=False)
