...
X_train = np.load('datasets/X_train_mfcc.npy')
y_train = np.load('datasets/y_train_mfcc.npy')
X_test = np.load('datasets/X_test_mfcc.npy')
y_test = np.load('datasets/y_test_mfcc.npy')
...
model.save('model_mfcc_{}_epochs.h5'.format(num_epochs))
pd.DataFrame.from_dict(history.history).to_csv('history_mfcc_{}_epochs.csv'.format(num_epochs),index=False)
