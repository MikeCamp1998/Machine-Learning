...
model.save('12_lang_model_5s_{}_epochs.h5'.format(num_epochs))
pd.DataFrame.from_dict(history.history).to_csv('12_lang_history_5s_{}_epochs.csv'.format(num_epochs),index=False)
