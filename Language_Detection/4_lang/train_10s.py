...
model.save('model_10s_{}_epochs.h5'.format(num_epochs))
pd.DataFrame.from_dict(history.history).to_csv('history_10s_{}_epochs.csv'.format(num_epochs),index=False)
